                                    ...
                                    <div class="megamenu">
                                        <div class="row">
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                                                <h4 class="menu-title">Unelte diagnoză</h4>
                                                <ul>
                                                    <li><a href="../diag.php">Toate produsele</a></li>
                                                    <li><a href="../diag.php#servis">Diagnoză Servis<span class="tip tip-hot">Hot</span></a></li>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                                                ...
                                                <ul>
                                                    <li><a href="../battery.php">Toate produsele</a></li>
                                                    <li><a href="../battery.php#tester">Testere baterie<span class="tip tip-hot">Hot</span></a></li>
                                            ...
                                            <div class="col-6 col-sm-4 col-md-3 col-lg-4">
                                                <h4 class="menu-title">Programare chei<span class="tip tip-new">Nou</span></h4>
                                                <ul>
